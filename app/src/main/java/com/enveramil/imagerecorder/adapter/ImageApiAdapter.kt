...
constructor(val glide : RequestManager)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ImageApiHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.fragment_image_api,parent,false)
    ...
    override fun onBindViewHolder(holder: ImageApiHolder, position: Int) {
        val imageView = holder.itemView.findViewById<ImageView>(R.id.singleImageView)
